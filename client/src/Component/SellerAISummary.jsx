...
export default function SellerAISummary({ sellerId }) {
  ...
  <div className="ai-summary-header">
    <h3 className="ai-summary-title">Seller review summary (AI)</h3>
  ...
  {loading ? (
    <p className="ai-summary-muted">Loading summary…</p>
  ) : error ? (
    <p className="ai-summary-error">Error: {error}</p>
  ) : (
    <>
